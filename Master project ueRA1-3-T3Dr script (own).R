...
#Figure 3A (differentially expressed genes per cluster)
...
DotPlot(ueRA, features=c("CXCR3","MTOR","TNFSF11"),
        assay="RNA")+xlab("Genes")+ylab("Cluster")
