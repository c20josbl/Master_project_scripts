##Master project integration and reclustering script (own)
...
ueRA = RunPCA(ueRA, features = VariableFeatures(ueRA),verbose=FALSE)
ElbowPlot(ueRA, reduction = "pca", ndims = 50)
